...
![]({{ site.url }}{{ site.baseurl }}/images/respic/SmartTip.png){: style="width: 400px; float: left; margin: 20px  20px"}
...
**Ultra-stable SI-STM instrument.**  ![]({{ site.url }}{{ site.baseurl }}/images/respic/STMHead.png){: style="width: 400px; float: right; margin: 20px 20px"}
